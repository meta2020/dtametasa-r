...
#   a <- -0.91
  ...
  # title(title, cex.main = 1.5, outer = TRUE)
...
tl1 <- TeX("$(c_1, \\,c_2) = (1/\\sqrt{2}, 1/\\sqrt{2})$")
tl2 <- TeX("$(c_1, \\,  c_2) = (1, 0)$")
tl3 <- TeX("$(c_1, \\,  c_2) = (0, 1)$")
...
.imput.plot(s.rdt1, list.n, 3, a = -1.51, 
           title ="", seed = seed, yaxt = NULL)
mtext("FPR", line = 3, side = 1, at = 0.5, cex = 0.7)
mtext(rep("TPR",2), line = 3, side = 2, at = c(0.5, 1.6), cex = 0.7)
mtext(tl1, cex= title.cex, side = 3, at = 0.5, line = line)


.imput.plot(s.rdt2, list.n, 3, a = -1.21, 
           title = "", seed = seed, yaxt = "n")
mtext("FPR", line = 3, side = 1, at = 0.5, cex = 0.7)
mtext(tl2, cex = title.cex, side = 3, at = 0.5, line = line)

.imput.plot(s.rdt3, list.n, 3, a = -1.05, 
           title = "", seed = seed, yaxt = "n")
mtext("FPR", line = 3, side = 1, at = 0.5, cex = 0.7)
mtext(tl3, cex = title.cex, side = 3, at = 0.5, line = line)


par(fig = c(0, 1, 0, 1), oma = c(0, 0, 0, 0), mar = c(1, 0, 4, 0), new = TRUE)
...
legend('bottom',
       ...
       lty = c(0,0,1,2, rep(1,4))[legend_order],
       pch = c(19,1,0,0, rep(18,4))[legend_order],
       xpd = TRUE, 
       #horiz = TRUE, 
       cex = 1.5,
       pt.cex =c(1.2, 1.2, 0, 0, rep(2,4))[legend_order],
       #seg.len=1, 
       bty = 'n',
       ncol = 4)
