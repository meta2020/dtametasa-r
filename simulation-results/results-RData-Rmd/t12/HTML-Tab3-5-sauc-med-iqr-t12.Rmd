...
save.tex <- FALSE
# save.tex <- TRUE; save.path <- "~/Documents/GitHub/Manu1/SIM-2/SIM-ver2-1221/tab/"
...
if (save.tex) sink(paste0(save.path, "tb-sauc-t12-c11.tex"))
...
if (save.tex) sink(paste0(save.path, "tb-sauc-t12-c10.tex"))
...
if (save.tex)  sink(paste0(save.path, "tb-sauc-t12-c01.tex"))
