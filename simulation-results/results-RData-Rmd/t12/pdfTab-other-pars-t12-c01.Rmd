...
if (save.tex) sink(paste0(save.path, "tb-par1-t12-c01.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c01-par1",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (0,1)$ (Scenario No.1-2)")
...
if (save.tex) sink(paste0(save.path, "tb-par2-t12-c01.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c01-par2",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (0,1)$ (Scenario No.3-4)")
...
if (save.tex) sink(paste0(save.path, "tb-par3-t12-c01.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c01-par3",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (0,1)$ (Scenario No.5-6)")
