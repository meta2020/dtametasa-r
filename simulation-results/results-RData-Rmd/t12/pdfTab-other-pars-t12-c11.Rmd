---
title: "Estimates of Parameters ($c_1=1, c_2=1$)"
author: "Yi"
...
if (save.tex) sink(paste0(save.path, "tb-par1-t12-c11.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c11-par1",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (1/\\sqrt{2}, 1/\\sqrt{2})$ (Scenario No.1-2)")
...
if (save.tex) sink(paste0(save.path, "tb-par2-t12-c11.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c11-par2",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (1/\\sqrt{2}, 1/\\sqrt{2})$ (Scenario No.3-4)")
...
if (save.tex) sink(paste0(save.path, "tb-par3-t12-c11.tex"))
...
kbl(longtab.f, 
    ...
    escape = FALSE,
				label = "c11-par3",
    caption = "Estimates of the parameters under the true selective publication mechanism of $(c_1, c_2) = (1/\\sqrt{2}, 1/\\sqrt{2})$ (Scenario No.5-6)")
