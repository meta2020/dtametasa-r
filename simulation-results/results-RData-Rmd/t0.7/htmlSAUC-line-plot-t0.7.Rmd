...
auc.med <- function(row.n){
  ...
  matplot(e.auc, type = "b", #pch = rep(20,5),
          ...
          ylim =c(y1, y2),
          col = c(1:6), xaxt="n")
  axis(1, at = 1:3, labels = c("10", "35", "140"))
...
```{r}
load("../../scenarios/scenarios-t0.7/set-t0.7-c11.RData")
...
load("../../scenarios/scenarios-t0.7/set-t0.7-c10.RData")
...
load("../../scenarios/scenarios-t0.7/set-t0.7-c01.RData")
