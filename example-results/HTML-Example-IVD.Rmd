...
par(oma = c(7, 2, 0.2, 0.2), mfrow = c(1, 3), mar = c(4, 2, 0.2, 0.2))
...
legend_order <- matrix(1:8, ncol=2, byrow = TRUE)
...
legend('bottom',
       legend = c("Filled studies", 
                  ...
                  "p < 0.01",
                  "0.01 < p < 0.05",
                  "0.05 < p < 0.1")[legend_order],
                  # "Semi-quantitative segment cultures",
                  # "Quantitative segment cultures")[legend_order],
       pch = c(1,rep(21, 3),rep(22, 3), NA)[legend_order],
       pt.bg = c(1:4, "#E6E6E6", "#B3B3B3", "#808080", NA)[legend_order], 
       xpd = TRUE, 
       horiz = FALSE, 
       cex = 1.2,
