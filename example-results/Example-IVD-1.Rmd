...
if(save.results)  sink("TAB-RES-IVD.tex")
...
par(oma = c(6,1,1,1), mfrow = c(1, 3), mar = c(4, 4, 3, 1))
...
legend('bottom',
       legend = c("Unpublished studies", 
                  ...
                  "Published studies with other cutoffs",
                  "Semi-quantitative segment cultures",
                  "Quantitative segment cultures")[legend_order],
       pch = c(1,rep(21, 3),19,17)[legend_order],
       pt.bg = c(1:4,1,1)[legend_order], 
       xpd = TRUE, 
       horiz = FALSE, 
       cex = 1.2,
